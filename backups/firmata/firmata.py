...
# For EEPROM
EEPROM_READ = 0x40 # read from EEPROM
EEPROM_WRITE = 0x41 # write to EEPROM
EEPROM_RESPONSE = 0x42 # response message form EEPROM
...
class Arduino:
    ...
    def read_eeprom (self, addr):
        ...
        data.append(EEPROM_READ)
        data.append(addr & 0x7F)
        data.append(addr >> 7)
        ...
        result = __parse_response(response)
